...
public class MentorService {
    ...
    public MentorSessionResponse startSession(
        ...
        if (session != null) {
            ...
            MentorMessageEntity lastMessage =
                    mentorMessageRepository
        ...
        MentorSessionEntity savedSession =
        ...
        String prompt = """
                ...
                IMPORTANT:
                - Do NOT dump the entire lesson to the student.
                - Do NOT simply copy the knowledge section.
                - Teach one small concept at a time.
                - Be friendly and encouraging.
                - Use simple language.
                - Ask the student one simple question.
                - The student should participate in the lesson.
                - Use Hospitality-related examples when appropriate.

                Your response should feel like a real tutor
                talking directly to a student.
        ...
        savedSession.setLastActivityAt(
                LocalDateTime.now()
        );

        mentorSessionRepository.save(savedSession);
        ...
        response.setModuleId(moduleId);
        response.setHaloMessage(haloMessage);
